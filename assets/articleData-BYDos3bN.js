const a={"pop-art":{id:"pop-art",date:"2018-08-27",title:"波普藝術－漫畫是藝術嗎？",category:"GraphicStyle",categoryName:"視覺風格大全",excerpt:"早在第一次世界大戰期間產生的達達主義思潮，杜象（Henri-Robert-Marcel Duchamp）就用《噴泉》，連鎖店購買的小便斗，使用現成物、日常生活用品試圖傳統藝術拉下崇高的殿堂，提問什麼是藝術？",image:"/assets/imgs/blog/pop-art.jpg",thumbnail:"/assets/imgs/blog/pop-art.jpg",author:"Homer Shie",content:`
<article>
  <!-- 首圖 -->
  <figure class="image">
    <img
...
`,seo:{description:"新藝術運動（Art Nouveau）則是延續這個時代浪潮下的視覺風格。在歐洲不同國家有不同稱呼：德國Jugendstil、奧地利Sezessionstil、意大利Stile Floreale",keywords:"視覺風格, 設計, 藝術, 插畫, 平面設計, 荷馬桑, homershie, 設計史, 藝術史, 藝術運動, 視覺, 工業革命, 美術工藝運動, 新藝術運動, 裝飾藝術, 嬉皮, 迷幻藝術, 迷幻搖滾, 古典, 復古, 唯美, 浪漫, 慕夏, 高更, 羅特列克, 切雷, 少女, 庫洛魔法使, 魔法少女, 少女漫畫"}}};export{a};
